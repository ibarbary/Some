...
exports.ResetPasswordSchema = exports.VerifyOtpSchema = exports.ForgetPasswordSchema = exports.confirmEmailSchema = exports.LoginSchema = exports.OAuthSchema = exports.SignUpSchema = void 0;
...
exports.OAuthSchema = {
    body: zod_1.default.strictObject({
        provider: zod_1.default.enum(["google", "facebook", "local"]),
        token: zod_1.default.string().nonempty("token is required"),
        role: zod_1.default.enum(user_model_1.RoleEnum).default(user_model_1.RoleEnum.User),
    }),
};
exports.LoginSchema = {
...
exports.VerifyOtpSchema = {
    body: zod_1.default.strictObject({
        email: validation_middelware_1.generalFields.email,
        otp: zod_1.default.string().regex(/^\d{6}$/, { message: "OTP must be 6 digits" }),
    }),
};
